...
KERNEL_FILTER = 'push|pop|xchg|add|sub|xor|or|and|mov|lea|ret|jmp|call|nop|syscall|leave'
...
class Exrop(object):
    ...
    def stack_pivot_reg(self, reg_name, avoid_char=None, used_dispatch=None):
